...
if (charCount === 0) {
  const seedChars = [
    {id:1,name:'蝴蝶女孩',isNew:1,cat:'现代都市',grad:'linear-gradient(160deg,#831843,#ec4899,#fbcfe8)',files:'["png"]',img:'蝴蝶女孩.png',imgs:null,fla:null},
    ...
    {id:3,name:'灰衣',isNew:1,cat:'现代都市',grad:'linear-gradient(160deg,#374151,#6b7280,#d1d5db)',files:'["png"]',img:'灰衣.png',imgs:null,fla:null},
